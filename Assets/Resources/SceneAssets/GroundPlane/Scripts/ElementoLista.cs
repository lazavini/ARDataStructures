...
namespace Assets.Resources.SceneAssets.GroundPlane.Scripts
{
    public class ElementoLista : Elemento
    {
        public override void CalculateTransform()
        {
            ...
            _cube.transform.localPosition = new Vector3((((ElementoLista)_parentElemento)?._cube?.transform?.localPosition.x ?? 0) + 0.1f, 0, 0);
            ...
            _line.transform.localPosition = new Vector3((((ElementoLista)_parentElemento)?._cube?.transform?.localPosition.x ?? 0) + 0.03f, 0, 0);
